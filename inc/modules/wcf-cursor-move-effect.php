...
class WCF_Cursor_Move_Effects
{
	...
	public static function register_mouse_move_effect_controls($element)
	{
		...
		$element->start_controls_section(
			...
			[
				'label' => sprintf('<i class="wcf-logo"></i> %s <span class="wcfpro_text">%s<span>', __('Mouse Move Effect', 'carvia-core'), __('Pro', 'carvia-core')),
		...
		$element->add_control(
			...
			[
				'label'              => esc_html__('Enable', 'carvia-core'),
		...
		$element->add_control(
			...
			[
				'label'              => esc_html__('Movement Wrapper', 'carvia-core'),
		...
		$element->add_control(
			...
			[
				'label'              => esc_html__('Custom Area', 'carvia-core'),
				'description'        => esc_html__('Please use the parent section or container class where the element will be movable.', 'carvia-core'),
				'type'               => Controls_Manager::TEXT,
				'ai'                 => false,
				'placeholder'        => esc_html__('.movement_area', 'carvia-core'),
				'frontend_available' => true,
				'render_type'        => 'none',
				'condition'          => [
		...
		$element->add_control(
			'wcf_mouse_move_x',
			[
				'label'              => esc_html__('Move X', 'carvia-core'),
		...
		$element->add_control(
			'wcf_mouse_move_y',
			[
				'label'              => esc_html__('Move Y', 'carvia-core'),
				'type'               => Controls_Manager::NUMBER,
				'default'            => 70,
				'frontend_available' => true,
				'condition'          => ['wcf_enable_mouse_move_effect!' => ''],
		...
		$element->add_control(
			...
			[
				'label'       => esc_html__('Customs', 'carvia-core'),
				'type'        => Controls_Manager::TEXTAREA,
				'rows'        => 5,
				'placeholder' => esc_html__('property:value, property2:value2', 'carvia-core'),
				'render_type' => 'none', // template
				'frontend_available' => true,
				'condition'   => [
					'wcf_enable_mouse_move_effect!' => '',
