...
class WCF_Smooth_Scroller
{
	...
	public static function register_sm_scroll_controls($document)
	{
		...
		$document->start_controls_section(
			...
			[
				'label' => sprintf('<i class="wcf-logo"></i> %s <span class="wcfpro_text">%s<span>', __('ScrollSmoother', 'carvia-core'), __('Pro', 'carvia-core')),
		...
		$document->add_control(
			...
			[
				...
				'default'      => '',
				'render_type' => 'ui',
				'description'  => __('Disbale ScrollSmoother For This Page', 'carvia-core'),
			]
		);
