...
class WCF_Cursor_Hover_Effects
{
	...
	public static function register_cursor_hover_effect_controls($element)
	{
		...
		$element->start_controls_section(
			...
			[
				'label' => sprintf('<i class="wcf-logo"></i> %s <span class="wcfpro_text">%s<span>', __('Cursor hover effect', 'carvia-core'), __('Pro', 'carvia-core')),
				'tab'   => $tab,
			]
		);
		...
		$element->add_control(
			...
			[
				...
				'frontend_available' => true,
				'separator'          => 'after',
				'default'            => esc_html__('View', 'carvia-core'),
			]
		);
