...
class WCF_Hover_Effect_Image
{
	...
	public static function register_hover_image_controls($element)
	{
		$element->start_controls_section(
			...
			[
				'label' => sprintf('<i class="wcf-logo"></i> %s <span class="wcfpro_text">%s<span>', __('Image Reveal on Hover', 'carvia-core'), __('Pro', 'carvia-core')),
		...
		$element->add_responsive_control(
			...
			[
				'label'      => esc_html__('Position Top', 'carvia-core'),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => ['px', '%'],
				'range'      => [
					'px' => [
		...
		$element->add_responsive_control(
			...
			[
				'label'      => esc_html__('Position Left', 'carvia-core'),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => ['px', '%'],
				'range'      => [
					'px' => [
		...
		$element->add_control(
			...
			[
				'label' => esc_html__('Z-index', 'carvia-core'),
