...
class WCF_Horizontal_Scroll
{
	...
	public static function register_horizontal_scroll_controls($element)
	{
		...
		$element->start_controls_section(
			...
			[
				'label' => sprintf('<i class="wcf-logo"></i> %s <span class="wcfpro_text">%s<span>', __('Horizontal Scroll', 'carvia-core'), __('Pro', 'carvia-core')),
		...
		$element->add_control(
			'important_note',
			[
				'label'           => esc_html__('Important Note', 'carvia-core'),
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => esc_html__('Please use full width Container to work properly.', 'carvia-core'),
		...
		$element->add_control(
			...
			[
				...
				'description'        => esc_html__('Note: Choose at which breakpoint horizontal scroll will work.', 'carvia-core'),
