...
// ─── Constants ────────────────────────────────────────────────
define('CARVIA_CORE_VERSION', '1.0.0');
define('CARVIA_CORE_FILE',    __FILE__);
define('CARVIA_CORE_DIR',     plugin_dir_path(CARVIA_CORE_FILE));
define('CARVIA_CORE_URI',     plugin_dir_url(CARVIA_CORE_FILE));
 ...
 *
 * The init class that runs the Elementor Carvia_Core plugin.
 * The main class that initiates and runs the plugin.
 * Intended To make sure that the plugin's minimum requirements are met.
 * @since 1.0.0
 */

final class Carvia_Core
{
