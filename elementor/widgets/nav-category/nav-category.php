...
/**
 * carvia_core nav category widget for elementor
 * @package Carvia_Core
 * @since 1.0.0
 */
...
class Nav_Category extends Widget_Base
{
    ...
    {
        return 'carvia-nav-category';
    }

    public function get_title()
    {
        return __('Nav Category', 'carvia-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'sticky_menu',
            [
                'label' => __('Sticky Menu', 'carvia-core'),
                'tab'   => Controls_Manager::TAB_CONTENT,
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'carvia-core'),
                'label_off' => __('No', 'carvia-core'),
                'return_value' => 'yes',
                'default' => 'yes',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .carvia-nav-menu-wrap ul li a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            'menu_global_margin',
            [
                'label' => __('Margin', 'carvia-core'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .carvia-nav-menu-wrap ul li a' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Typography', 'carvia-core'),
                'selector' => '{{WRAPPER}} .carvia-nav-menu-wrap ul .sub-menu a, .carvia-nav-menu-wrap ul.children li a',
            ]
        );
        $this->add_responsive_control(
            'dropdown_menu_width',
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .carvia-nav-menu-wrap ul .sub-menu, .carvia-nav-menu-wrap ul.children' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .carvia-nav-menu-wrap ul .sub-menu, .carvia-nav-menu-wrap ul.children' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .carvia-nav-menu-wrap ul .sub-menu, .carvia-nav-menu-wrap ul.children',
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .carvia-nav-menu-wrap ul .sub-menu, .carvia-nav-menu-wrap ul.children' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .carvia-nav-menu-wrap ul .sub-menu a, .carvia-nav-menu-wrap ul.children li a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_section();
        ...
        $this->add_control(
            'sticky_menu_color',
            [
                'label' => __('Menu Color', 'carvia-core'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .enable-sticky .carvia-nav-menu-wrap ul li a' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
