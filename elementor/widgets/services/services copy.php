    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            array(
                ...
                'default' => 'layout_one',
                'options' => array(
                    'layout_one'  => esc_html__('Layout 1', 'carvia-core'),
                    'layout_t' => esc_html__('Layout 2', 'carvia-core'),
                ),
            )
        );
...
?>
        <div class="services-card-wrap carvia-layout-<?php echo esc_attr($settings['layout_style']); ?>">
